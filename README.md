...
Cada pasta psetX/ representa um conjunto de problemas (problem set) propostos no curso. O diretório projeto-final/ conterá meu projeto final, integrando os conceitos aprendidos.
